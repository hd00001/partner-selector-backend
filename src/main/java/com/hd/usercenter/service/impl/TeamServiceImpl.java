...
import com.hd.usercenter.model.enums.TeamStatusEnum;
...
import com.hd.usercenter.model.vo.UserVO;
import com.hd.usercenter.service.TeamService;
import com.hd.usercenter.mapper.TeamMapper;
...
//        如果队伍状态改为加密，必须要有密码
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("hd:join_team");
        try {
            // 抢到锁并执行
            while (true) {
